...
public class HomeScreen{
	public static final int WIDTH = MainApplication.WIDTH;
	public static final int HEIGHT = MainApplication.HEIGHT;
	private static final int FPS = 40;
	private static final Image PLAY_BUTTON = WebfxUtil.loadImage("play_button.png");
